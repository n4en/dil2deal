...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gray-900">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-blue-100 to-green-100 dark:from-gray-800 dark:to-gray-900 py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900 dark:text-white">Discover Amazing Local Deals</h1>
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-8">Find the best offers from local businesses in your area. Save money while supporting your community.</p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="section-title mb-8 text-3xl font-semibold text-center">Featured Deals</h2>
